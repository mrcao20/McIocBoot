...
#define MC_IOC_MINOR 3 // version when you make small feature changes.
#define MC_IOC_PATCH 0 // version when you make backwards-compatible bug fixes.
#define MC_IOC_INTERNAL 1 // MC_IOC_INTERNAL version for perpurse like feature test, bug fix test,development, et
